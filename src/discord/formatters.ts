...
export function helpMessage(): string {
  return [
    ...
    '/help',
    '',
    'Trigger phrase for plain text and voice:',
    '"Hey Kirby, ..."',
    '',
    'Plain text examples:',
    '"Hey Kirby, add broccoli to the pantry list and give it an expiration date of May 12, 2026."',
    '"Hey Kirby, add milk to fridge, expires next Friday."',
    '"Hey Kirby, what food is expiring this week?"',
    '',
    'Voice messages:',
